 ...
 * 5. map => Tạo ra một mảng mới bằng cách áp dụng một hàm nào đó lên từng phần tử của mảng gốc.
 * 6. find
 */
...
const diemToan = [8, 7, 6, 4, 5, 6, 2, 3, 1, 10];

const diemToanSauKhiCong1 = diemToan.map((point) => point + 1 && point + 1 <= 10 ? point + 1 : 10);
console.log(diemToanSauKhiCong1);
